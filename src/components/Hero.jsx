      ...
      <div className="container mx-auto flex flex-col items-center bg-yellow-600 px-5 py-24 md:flex-row md:gap-x-20 lg:gap-x-48">
        <div className="lg:flex-grow mb-16 flex flex-col items-center bg-red-600 text-center">
          ...
          <div className="flex w-full items-end justify-center">
            ...
            <Link
              to={"/login"}
              className="inline-flex rounded-md border-0 bg-orange-600 px-6 py-2 text-lg capitalize text-white hover:bg-orange-500 focus:outline-none"
            >
              sign in
            </Link>
          </div>
          ...
          <div className="flex gap-4 text-gray-100 md:flex-col lg:flex-row">
            <button onClick={notify} className="hero_btn">
              ...
              <span className="ml-4 flex flex-col items-start leading-none">
                <span className="mb-1 text-xs text-gray-100">GET IT ON</span>
            ...
            <button onClick={notify} className="hero_btn">
              ...
              <span className="ml-4 flex flex-col items-start leading-none">
                <span className="mb-1 text-xs text-gray-100">
                  Download on the
                </span>
