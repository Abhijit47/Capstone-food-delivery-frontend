...
const MealCard = ({ meal, setAllMeals }) => {
  ...
  return (
    <>
      ...
      <h2 className="text-center text-4xl text-black">TEST</h2>
      <div className="grid justify-items-center gap-6 xs:grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          ...
          >
            ...
            <div className="relative rounded-b-md border-b-4 border-orange-300 bg-white p-6">
              ...
              <p className="text-xs text-gray-700">
                Item remains&nbsp;{product.quantity}
              </p>

              <button className="mt-4 block w-full rounded-md bg-orange-400 p-4 text-sm font-medium transition-all hover:scale-105">
                Add to Cart
              </button>
            </div>
          </div>
