      ...
      <div className="2xl:mx-auto 2xl:container py-9 px-4 md:px-20 md:py-12">
        <div className="relative rounded-md">
          ...
          <div className="relative top-0 z-20 flex h-full w-full flex-col justify-between rounded-md bg-gradient-to-r from-blue-700 to-transparent p-6 text-xl md:p-16 ">
            <div>
              <h5 className="w-64 text-3xl font-bold leading-9 text-white xs:text-3xl sm:w-auto md:text-5xl md:leading-10">
            ...
            <div className="mt-20 w-full md:mt-12">
              <Link
                to={"/contact-us"}
                className="w-full rounded-md bg-white font-medium leading-4 text-indigo-700 shadow-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 xs:p-2 xs:text-xs sm:w-auto lg:p-4 lg:text-base"
              >
                Contact us
              </Link>
            </div>
