        ...
        <div className="relative rounded-md">
          ...
          <div className="relative top-0 z-20 flex h-full w-full flex-col justify-between rounded-md bg-gradient-to-r from-blue-700 to-transparent p-6 text-xl md:p-16 ">
            ...
            <div className="mt-20 md:mt-12">
              <button className="rounded w-full bg-white p-4 text-base font-medium leading-4 text-indigo-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 sm:w-auto">
                Explore More
              </button>
            </div>
          </div>
