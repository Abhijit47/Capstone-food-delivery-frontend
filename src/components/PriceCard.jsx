    ...
    <section className="body-font overflow-hidden text-gray-600">
      <div className="container mx-auto px-5 py-24">
        <div className="mb-20 flex w-full flex-col text-center">
          ...
          <div className="rounded mx-auto mt-6 flex overflow-hidden border-2 border-indigo-500">
        ...
        <div className="-m-4 flex flex-wrap">
          <div className="w-full p-4 md:w-1/2 xl:w-1/4">
            <div className="relative flex h-full flex-col overflow-hidden rounded-lg border-2 border-gray-300 p-6">
              ...
              <button className="rounded mt-auto flex w-full items-center border-0 bg-gray-400 px-4 py-2 text-white hover:bg-gray-500 focus:outline-none">
                Button
                <svg
                  fill="none"
                  stroke="currentColor"
          ...
          <div className="w-full p-4 md:w-1/2 xl:w-1/4">
            <div className="relative flex h-full flex-col overflow-hidden rounded-lg border-2 border-indigo-500 p-6">
              ...
              <button className="rounded mt-auto flex w-full items-center border-0 bg-indigo-500 px-4 py-2 text-white hover:bg-indigo-600 focus:outline-none">
                Button
                <svg
                  fill="none"
                  stroke="currentColor"
